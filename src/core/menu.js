        ...
        <>
           {context.approve?.approve&&<Containers >
                <div className="container menuPar">
                    <div className="row">
                        <div className={loc.pathname.includes(`intro`)?`col-md-2 items active`:`col-md-2 items`}><Link to={`/${paramC}/intro/1`}><span >Төслийн болон Аж ахуйн нэгжийн танилцуулга</span></Link></div>
                        <div className={loc.pathname.includes(`businessinfo`)?`col-md-2 items active`:`col-md-2 items`}><Link to={`/${paramC}/businessinfo/1`}><span>Дотоодын зах зээл дэх бизнесийн мэдээлэл</span></Link> </div>
                        <div className={loc.pathname.includes(`export`)?`col-md-2 items active`:`col-md-2 items`}><Link to={`/${paramC}/export/1`}><span>Экспортын бүтээгдэхүүн, үйлчилгээ</span></Link> </div>
                        <div className="col-md-2 items"><span>Экспортын зах зээлийн судалгаа</span></div>
                        <div className="col-md-2 items"><span>Маркетингийн стратеги</span></div>
                        <div className="col-md-2 items"><Link to={`/${paramC}`}><span>Төлөвлөгөө болон уулзалт, тайлан</span></Link></div>
                    </div>
                </div>
