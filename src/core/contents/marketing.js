    ...
    return (
        <HeaderTwo className="container">
            <div className="smMenuPar">
                <button onClick={()=>clickHanlde("show1")} className={`itemsPar ${loc.pathname===`/${params}/marketing/1`&&`itemsPar2`}`}><span>Бүтээгдэхүүн</span></button>
                <button onClick={()=>clickHanlde("show2")} className={`itemsPar ${loc.pathname===`/${params}/marketing/2`&&`itemsPar2`}`} ><span>Үнэ</span></button>
                <button onClick={()=>clickHanlde("show3")} className={`itemsPar ${loc.pathname===`/${params}/marketing/3`&&`itemsPar2`}`}><span>Зах зээлд нэвтрэлт, хуваарилалтын сувгууд</span></button>
                <button onClick={()=>clickHanlde("show4")} className={`itemsPar ${loc.pathname===`/${params}/marketing/4`&&`itemsPar2`}`}><span>Идэвхижүүлэлт</span></button>
                <button onClick={()=>clickHanlde("show5")} className={`itemsPar ${loc.pathname===`/${params}/marketing/5`&&`itemsPar2`}`}><span>Үйл явц</span></button>
            </div>
