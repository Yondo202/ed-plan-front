    ...
    return (
        <HeaderTwo >
            <div className="smMenuPar container">
                <button className={`itemsPar ${loc.pathname===`/${params}/report/1`&&`itemsPar2`}`}><span>Үйл ажиллагаа болон санхүүгийн төлөвлөгөө</span></button>
                <button className={`itemsPar ${loc.pathname===`/${params}/report/2`&&`itemsPar2`}`} ><span>Удирдлагын багийн уулзалт, тайлан</span></button>
            </div>
